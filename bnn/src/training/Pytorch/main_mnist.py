...
class Net(nn.Module):
    def __init__(self):
        ...
        self.bn1 = nn.BatchNorm1d(1024*self.infl_ratio, eps=1e-4)
        self.fc2 = BinarizeLinear(1024*self.infl_ratio, 1024*self.infl_ratio)
        self.htanh2 = nn.Hardtanh()
        self.bn2 = nn.BatchNorm1d(1024*self.infl_ratio, eps=1e-4)
        self.fc3 = BinarizeLinear(1024*self.infl_ratio, 1024*self.infl_ratio)
        self.htanh3 = nn.Hardtanh()
        self.bn3 = nn.BatchNorm1d(1024*self.infl_ratio, eps=1e-4)
        self.fc4 = nn.Linear(1024*self.infl_ratio, 10)
        self.bn4 = nn.BatchNorm1d(10*self.infl_ratio, eps=1e-4)
