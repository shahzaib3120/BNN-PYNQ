...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch Quantized Resnet (CIFAR10) Example')
parser.add_argument('--batch-size', type=int, default=512, metavar='N', help='input batch size for training (default: 256)')
...
save_path='results/resnet-w{}a{}.pt'.format(args.wb, args.ab)
prev_acc = 0
...
class Resnet(nn.Module):
    ...
    def export(self):
        ...
        save_file = 'results/resnet-w{}a{}.npz'.format(args.wb, args.ab)
