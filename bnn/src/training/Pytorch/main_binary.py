...
parser.add_argument('--model', '-a', metavar='MODEL', default='alexnet', choices=model_names, help='model architecture: ' + ' | '.join(model_names) + ' (default: alexnet)')
...
parser.add_argument('--type', default='torch.FloatTensor', help='type of tensor - e.g torch.cuda.HalfTensor')
...
parser.add_argument('--epochs', default=2500, type=int, metavar='N', help='number of total epochs to run')
