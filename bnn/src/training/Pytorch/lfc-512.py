...
parser = argparse.ArgumentParser(
    description='PyTorch Quantized LFC (MNIST) Example')
...
parser.add_argument('--wb', type=int, default=1, metavar='N',
                    choices=[1, 2, 4], help='number of bits for weights (default: 1)')
parser.add_argument('--ab', type=int, default=1, metavar='N',
                    choices=[1, 2, 4], help='number of bits for activations (default: 1)')
...
save_path = 'results/mnist-w{}a{}-512.pt'.format(args.wb, args.ab)
neurons = 512
prev_acc = 0
...
class lfc(nn.Module):
    def __init__(self):
        ...
        self.classifier = nn.Sequential(
            Quantizer(1),
            BinarizeLinear(args.wb, 28*28, neurons, bias=True),
    ...
    def export(self):
        ...
        save_file = 'results/mnist-w{}a{}-512.npz'.format(args.wb, args.ab)
