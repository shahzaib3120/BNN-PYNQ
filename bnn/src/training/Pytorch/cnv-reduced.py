...
save_path = 'results/cifar10-w{}a{}-reduced.pt'.format(args.wb, args.ab)
prev_acc = 0
...
class cnv(nn.Module):
    def __init__(self):
        ...
        self.features = nn.Sequential(
            BinarizeConv2d(args.wb, 3, 64, kernel_size=3,
                           stride=1, padding=0, bias=True),
            nn.BatchNorm2d(64),
            nn.Hardtanh(inplace=True),
            Quantizer(args.ab),

            BinarizeConv2d(args.wb, 64, 64, kernel_size=3,
                           stride=1, padding=0, bias=True),
            nn.BatchNorm2d(64),
            nn.Hardtanh(inplace=True),
            Quantizer(args.ab),
            ...
            BinarizeConv2d(args.wb, 64, 128, kernel_size=3,
                           padding=0, bias=True),
            nn.BatchNorm2d(128),
            nn.Hardtanh(inplace=True),
            Quantizer(args.ab),

            BinarizeConv2d(args.wb, 128, 128, kernel_size=3,
                           padding=0, bias=True),
            nn.BatchNorm2d(128),
            nn.Hardtanh(inplace=True),
            Quantizer(args.ab),
        ...
        self.classifier = nn.Sequential(
            BinarizeLinear(args.wb, 128*5*5, 256, bias=True),
            nn.BatchNorm1d(256),
            nn.Hardtanh(inplace=True),
            Quantizer(args.ab),

            BinarizeLinear(args.wb, 256, 10, bias=True),
            nn.BatchNorm1d(10),
            nn.LogSoftmax()
        )
    ...
    def export(self):
        ...
        save_file = 'results/cifar10-w{}a{}-reduced.npz'.format(
            args.wb, args.ab)
